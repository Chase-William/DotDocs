...
{
    public class ProjectTree : IDisposable
    {
        ...
        public void Save(string baseOutputPath)
            => RootProject.Save(baseOutputPath);
        ...
        {            
            LoadRecursive(RootProject, assemblies, typeMapper);
        }

        void LoadRecursive(LocalProject project, string[] assemblies, TypeMetaMapper typeMapper)
        {
            project.Load(assemblies, typeMapper);
            ...
            foreach (var proj in project.LocalProjects)
                LoadRecursive(proj, assemblies, typeMapper);            
        }
